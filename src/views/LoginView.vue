...
<template>
  <main
    class="min-h-screen bg-white md:bg-gray-50 flex flex-col md:items-center md:justify-center px-6 pt-16 md:pt-0 pb-8">
    ...
    <div class="w-full md:max-w-md md:bg-white md:rounded-2xl md:shadow-md md:p-8 flex flex-col gap-0">
      ...
      <form @submit.prevent="onSubmit" class="flex flex-col gap-5">
        <div>
          ...
          <input v-model="email" type="email" inputmode="email" autocomplete="email" placeholder="seu@email.com"
